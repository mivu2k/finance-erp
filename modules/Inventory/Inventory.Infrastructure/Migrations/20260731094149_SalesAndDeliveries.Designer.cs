...
namespace Inventory.Infrastructure.Migrations
{
    ...
    [Migration("20260731094149_SalesAndDeliveries")]
    partial class SalesAndDeliveries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domain.Delivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.DeliveryLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.GoodsReceipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.GoodsReceiptLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.PurchaseOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.DeliveryLine", b =>
                {
                    b.HasOne("Inventory.Domain.Delivery", "Delivery")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Inventory.Domain.GoodsReceipt", b =>
                {
                    b.HasOne("Inventory.Domain.PurchaseOrder", "PurchaseOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Domain.GoodsReceiptLine", b =>
                {
                    b.HasOne("Inventory.Domain.GoodsReceipt", "GoodsReceipt")
                        .WithMany("Lines")
